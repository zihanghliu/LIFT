...
OUTPUT=${OUTPUT_SRC_DIR}/${MODEL}/${adapter_name}/math/lr_${lr}/rank_${lora_r}_alpha_${lora_alpha}/seed_${seed}
mkdir -p $OUTPUT
...
bash ./bash_scripts/eval_math_lora.sh ${adapter_name} $MODEL $OUTPUT